...
if($_SESSION['post-data']['arr'] =='DAC' || $_SESSION['post-data']['arr'] =='CGP' && $_SESSION['post-data']['departure'] =='DAC' || $_SESSION['post-data']['departure'] =='CGP' ){
        ...
        if($total<=1){
        $command1 = "*".$_POST['MerchantTxnNo']."^MI^EZT*R^EZRE^*R~x";
        //echo $command1;

    }
    else{

//-4KHAN/SOYKETMR/FIRSTNAMEMRS/TOUSIFMSTR.CH10/MA^0RX0715Q20MARDACCGPNN3^4-1FPSPT/54454545/GB/09MAY84/KHAN/SOYKETMR^3-1FDOB 09-MAY-1984^3-1FGNDR MALE^FG^FS1^*R^MI^EZT*R^EZRE^*R~x
