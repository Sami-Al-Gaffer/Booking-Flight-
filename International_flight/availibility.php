...
<body>
  ...
  $date=$departure=$arrival=$adult=$child=$infant= "";
...
$command1 = "A".date("dM",strtotime($date))."".$departure."".$arrival."[SalesCity=".$departure.",VARS=True,ClassBands=True,StartCity=DAC,SingleSeg=s,FGNoAv=True,qtyseats=1]";
//echo $command1;
